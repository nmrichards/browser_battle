feature 'Hit points' do
  ...
  scenario "Player 1 attacks Player 2 after signin" do
    ...
    expect(page).to have_text("Jack attacked Nick")
  end
  ...
  scenario "Attack reduces player 2 HP on first attack" do
    ...
    click_button('OK')
    expect(page).to have_text("Jack's hit points: 100")
  end
  ...
  scenario "Second attack reduces player 1 HP" do
    ...
    click_button('Attack Nick')
    click_button('OK')
    click_button('Attack Jack')
    expect(page).to have_text("Jack's hit points are now: 90")
    click_button('OK')
